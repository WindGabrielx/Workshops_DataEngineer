...
with DAG(
    ...
    t4 = BashOperator(
        ...
        bash_command ="bq load \
            --source_format=CSV \
            --autodetect \
            workshop_5.audible_data1 \
            gs://us-central1-workshop4-e25f0be1-bucket/data/output.csv" #โดยมันจะโหลดข้อมูลจาก Path นี้เข้าไปใน workshop.audible_data1
    )

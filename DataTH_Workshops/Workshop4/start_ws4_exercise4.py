...
def get_data_from_mysql(transaction_path): #T1
...
def get_conversion_rate(conversion_rate_path): #T2
...
def merge_data(transaction_path, conversion_rate_path, output_path): #T3
